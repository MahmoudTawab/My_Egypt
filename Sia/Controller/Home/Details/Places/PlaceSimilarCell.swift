...
class PlaceSimilarCell : UICollectionViewCell {
    
    var Delegate : PlaceSimilarDelegate?
    ...
    @objc func SimilarPlacesAction() {
        Delegate?.PlaceCollectionAction(self)
    }
    ...
    @objc func ActionFavorites() {
        Delegate?.PlaceActionFavorites(self)
    }
