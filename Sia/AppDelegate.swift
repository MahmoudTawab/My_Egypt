...
class AppDelegate: UIResponder, UIApplicationDelegate ,MOLHResetable {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        // Google Maps
        GMSServices.provideAPIKey("AlzaSyA0LosaCIskHEkUa3omr-LtKQArveRGTWo")
        GMSPlacesClient.provideAPIKey("AlzaSyA0LosaCIskHEkUa3omr-LtKQArveRGTWo")
    ...
    func reset() {
        if defaults.string(forKey: "refreshToken") == "" && defaults.bool(forKey: "ShowLocalizable") == true  {
