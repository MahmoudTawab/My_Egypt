...
class PopUpCenterView: UIViewController {
  ...
  func SetUp() {
    ...
    IconImage.widthAnchor.constraint(equalToConstant: ControlWidth(100)).isActive = true
    IconImage.heightAnchor.constraint(equalToConstant: ControlWidth(100)).isActive = true
    ...
    StackVertical.heightAnchor.constraint(equalToConstant: ControlWidth(48)).isActive = true
    StackVertical.leadingAnchor.constraint(equalTo: view.leadingAnchor,constant: ControlX(30)).isActive = true
    StackVertical.trailingAnchor.constraint(equalTo: view.trailingAnchor,constant: ControlX(-30)).isActive = true
    StackVertical.bottomAnchor.constraint(equalTo: Background.bottomAnchor, constant: ControlX(-20)).isActive = true
  }
  ...
  lazy var LeftButton : UIButton = {
    ...
    lazy var Dismiss : UIButton = {
        ...
        Button.addTarget(self, action: #selector(ActionDismiss), for: .touchUpInside)
        Button.titleLabel?.font = UIFont(name: "Nexa-Bold", size: ControlWidth(25))
        return Button
    }()
