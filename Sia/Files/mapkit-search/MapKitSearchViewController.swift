...
public class MapKitSearchViewController: UIViewController, UIGestureRecognizerDelegate {
    ...
    public var searchCompletionRequest: MKLocalSearchCompleter? = MKLocalSearchCompleter()
    ...
    public var Textsearch: String = "" {
        ...
        self.searchRequestStart(Text: self.Textsearch)
        }
        }
    }
    ...
    public func searchRequestStart(Text: String,dismissKeyboard: Bool = false, isMapPan: Bool = false) {
        searchRequestCancel()
        let request = MKLocalSearch.Request()
        ...
        for annotation in mapView.annotations {
            if let placeAnnotation = annotation as? PlaceAnnotation {
                if placeAnnotation.mapItem == mapItem {
                    lat = placeAnnotation.coordinate.latitude
                    lon = placeAnnotation.coordinate.longitude
                    display_name = placeAnnotation.title
