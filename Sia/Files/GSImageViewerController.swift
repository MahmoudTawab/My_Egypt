...
open class GSImageViewerController: UIViewController {
    ...
    override open func viewDidLoad() {
        ...
        Cancel.setImage(UIImage(named: "right-arrow"), for: .normal)
        Cancel.addTarget(self, action: #selector(CancelAc), for: .touchUpInside)
        Cancel.contentEdgeInsets = UIEdgeInsets(top: 5, left: 5, bottom: 5, right: 5)
        Cancel.frame = CGRect(x: ControlX(15), y: ControlX(25), width: ControlWidth(40), height: ControlWidth(40))
    }
