...
public class BadgeHub: NSObject {
    ...
    public func setCircleAtFrame(_ frame: CGRect) {
        ...
        redCircle.layer.cornerRadius = ControlWidth(7.5)
        countLabel?.font = UIFont.systemFont(ofSize: frame.size.width / 2, weight: .bold)
    }
    ...
    public func setCount(_ newCount: Int) {
        ...
        countLabel?.text = "lang".localizable == "en" ? labelText:labelText.NumAR()
        checkZero()
    }
