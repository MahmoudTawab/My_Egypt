...
public let AnimationsView = [AnimationType.vector((CGVector(dx: 0, dy: ControlX(80)))),AnimationType.from(direction: .top, offset: ControlX(100))]
...
//    let rotateAnimation = AnimationType.rotate(angle: CGFloat.pi/6)
    ...
    func SetAnimations(_ selector: @escaping () -> Void = {}) {
        ...
        animations: AnimationsView,duration: 0.5, options: [.curveEaseInOut],
                       completion: {
        selector()
        })
        }, completion: nil)
