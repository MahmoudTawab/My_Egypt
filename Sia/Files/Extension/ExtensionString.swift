...
extension String {
    ...
    func TextHeight(_ width: CGFloat, font: UIFont, Spacing:CGFloat) -> CGFloat? {
    ...
    func Formatter(Format:String = "yyyy-MM-dd'T'HH:mm:ss") -> Date {
    ...
    func NumAR() -> String{
        ...
        for letter in letters {
            if (Int(letter) != nil) {
                let persianNumber = ["۰","۱","۲","۳","٤","٥","٦","۷","۸","۹"]
